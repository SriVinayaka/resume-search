document.addEventListener('DOMContentLoaded', () => {
  ...
  function displayApplicant(applicant) {
    ...
    const location = applicant.basics.location;
    for (const key in location) {
      document.getElementById(`${key}`).textContent = location[key];
    }
  
  //function displayApplicant(applicant) {
    // Access the HTML elements and update their content

    document.getElementById('network').textContent = applicant.id;
    ...
    document.getElementById('appliedFor').textContent = applicant.basics.image;
    ...
    document.getElementById('phone').textContent = applicant.basics.location.address;
    document.getElementById('phone').textContent = applicant.basics.location.postalCode;
    document.getElementById('phone').textContent = applicant.basics.location.city;
    document.getElementById('phone').textContent = applicant.basics.location.state;


    document.getElementById('network').textContent = applicant.basics.profiles.network;
    document.getElementById('network').textContent = applicant.basics.profiles.url;
